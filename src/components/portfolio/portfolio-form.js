...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://caparken20.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        };
    ...
    deleteImage(imageType) {
        ...
        { withCredentials: true }
            ...
            console.log("deleteImage is dead", error)
        })
    }
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://caparken20.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
