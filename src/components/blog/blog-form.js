...
import RichTextEditor from "../forms/rich-text-editor.js";
...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://caparken20.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  deleteImage(imageType) {
    axios.delete(`https://api.devcamp.space/portfolio/delete-portfolio-blog-image/${this.props.blog.id}?image_type=${imageType}`,
      ...
      console.log("response from dlog image delet", response)
    }).catch(error => {
      console.log("deleteBlogImage is dead", error)
    })
  }
  ...
  UNSAFE_componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://caparken20.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      })
    }
  }
